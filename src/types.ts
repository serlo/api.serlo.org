...
export type ResolversTypes = {
  ...
  Notification: ResolverTypeWrapper<ComputeModel<Notification>>;
  ...
  Event: ResolverTypeWrapper<ComputeModel<Event>>;
...
export type ResolversParentTypes = {
  ...
  Notification: ComputeModel<Notification>;
