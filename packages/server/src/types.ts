...
export type ResolversTypes = {
  ...
  SetEntityResponse: ResolverTypeWrapper<ModelOf<Omit<SetEntityResponse, 'record'> & { record?: Maybe<ResolversTypes['AbstractEntity']> }>>;
...
export type ResolversParentTypes = {
  ...
  SetEntityResponse: ModelOf<Omit<SetEntityResponse, 'record'> & { record?: Maybe<ResolversParentTypes['AbstractEntity']> }>;
